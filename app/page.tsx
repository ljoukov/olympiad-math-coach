      ...
      <main className="mx-auto max-w-4xl px-4 py-8 space-y-8">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-foreground">
            {"Welcome back"}
            {user?.persona
              ? ` (${user.persona.replace("_", " ").toLowerCase()})`
              : ""}
          </h1>
          <p className="text-muted-foreground">
            Choose what you would like to work on today.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-3">
          <Card
            className="group cursor-pointer border-2 border-primary/20 transition-all hover:border-primary hover:shadow-md"
          ...
          >
            ...
            <CardContent>
              <CardDescription>
                Work through olympiad problems with hints, claims, and feedback.
              </CardDescription>
            </CardContent>
          </Card>

          <Card
            className="group cursor-pointer border-2 border-transparent transition-all hover:border-primary/30 hover:shadow-md"
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Choose how you prefer to receive guidance during problem-solving
            sessions.
          </p>
          <PersonaSelector
            selected={user?.persona ?? null}
