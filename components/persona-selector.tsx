...
const personas = [
  {
    id: "COACH",
    title: "Coach",
    description: "Calm, supportive guidance. Step-by-step encouragement to build your confidence.",
    icon: "C",
  ...
  },
  {
    id: "QUIZ_MASTER",
    title: "Quiz Master",
    description: "Diagnostic questions and crisp feedback. Identifies exactly where you need to improve.",
    icon: "Q",
  ...
  },
  {
    id: "RIVAL",
    title: "Rival",
    description: "Challenges you to prove it. Pushes for rigour and precision in every step.",
    icon: "R",
          ...
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              <div className={cn(
                ...
                p.id === "COACH" ? "bg-blue-200 text-blue-800" :
                p.id === "QUIZ_MASTER" ? "bg-amber-200 text-amber-800" :
